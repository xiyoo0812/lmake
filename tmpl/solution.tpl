...
{{% local ALL_PROJS = {} %}}
{{% local ALL_GUID = GUID_NEW("all") %}}
Project("{2150E333-8FDC-42A3-9474-1A3956D46DE8}") = "all", "all", "{ {{%= ALL_GUID %}} }"
EndProject
{{% for _, GROUP in pairs(GROUPS or {}) do %}}
Project("{2150E333-8FDC-42A3-9474-1A3956D46DE8}") = "{{%= GROUP.NAME %}}", "{{%= GROUP.NAME %}}", "{ {{%= GROUP.GUID %}} }"
EndProject
...
{{% for _, PROJ in pairs(ALL_PROJS or {}) do %}}
		{ {{%= PROJ.GUID %}} }.ReleaseDebug|x64.ActiveCfg = ReleaseDebug|x64
		{ {{%= PROJ.GUID %}} }.ReleaseDebug|x64.Build.0 = ReleaseDebug|x64
		{ {{%= PROJ.GUID %}} }.ReleaseDebug|x86.ActiveCfg = ReleaseDebug|Win32
		{ {{%= PROJ.GUID %}} }.ReleaseDebug|x86.Build.0 = ReleaseDebug|Win32
{{% end %}}
	EndGlobalSection
...
{{% for _, PROJ in pairs(ALL_PROJS or {}) do %}}
		{ {{%= PROJ.GUID %}} } = { {{%= GUID_NEW(PROJ.GROUP) %}} }
{{% end %}}
{{% for _, GROUP in pairs(GROUPS or {}) do %}}
		{ {{%= GUID_NEW(GROUP.GUID) %}} } = { {{%= ALL_GUID %}} }
{{% end %}}
	EndGlobalSection
